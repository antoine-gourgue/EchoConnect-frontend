  ...
  <div class="flex bg-gray-100 text-gray-900">
    <aside class="flex h-screen w-20 flex-col items-center border-r border-gray-200 bg-white">
      ...
      <div class="flex flex-col items-center gap-y-4 py-10">
        <button class="group relative rounded-xl p-2 text-gray-600 hover:text-indigo-600">
          <div class="absolute inset-y-0 left-12 hidden items-center group-hover:flex">
            <div class="relative whitespace-nowrap rounded-md bg-white px-4 py-2 text-sm font-semibold text-gray-900 drop-shadow-lg">
              <div class="absolute inset-0 -left-1 flex items-center">
                <div class="h-2 w-2 rotate-45 bg-white"></div>
          ...
          <svg class="h-6 w-6 stroke-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M19.07 12.93v-1.86l1.43-1.1a1 1 0 00.25-1.26l-1.36-2.35a1 1 0 00-1.26-.25l-1.69 1.3a7.38 7.38 0 00-1.65-.96l-.25-1.98a1 1 0 00-.99-.74h-2.72a1 1 0 00-.99.74l-.25 1.98c-.57.2-1.1.45-1.65.96l-1.69-1.3a1 1 0 00-1.26.25l-1.36 2.35a1 1 0 00.25 1.26l1.43 1.1v1.86l-1.43 1.1a1 1 0 00-.25 1.26l1.36 2.35a1 1 0 001.26.25l1.69-1.3c.55.5 1.08.86 1.65.96l.25 1.98a1 1 0 00.99.74h2.72a1 1 0 00.99-.74l.25-1.98c.57-.1 1.1-.45 1.65-.96l1.69 1.3a1 1 0 001.26-.25l1.36-2.35a1 1 0 00-.25-1.26l-1.43-1.1z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
